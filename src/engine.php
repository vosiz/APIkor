...
final class Engine extends Singleton {
    ...
    // // TODO: Sets engine configuration
    ...
    public function Start() {
        ...
        try {
            ...
            // overi configuracni setup
            
            // all seems ok, set flag
    ...
    // TODO: Work, and die (nihilistic note...)
    public function Work() {
        ...
        try {
            ...
            if(!$this->Status->IsOk())
                throw new \Exception("Engine status is not OK");
    ...
    // TODO: vysle na vystup odpoved
    private function Response($params) {

        // vytvori obecny response
        //$this->Format(print_r($params, true));
    }


    // TODO: formatuje odpoved
    private function Format($string) {

        // formatuje odpoved podle pozadavku na vystup
        // echo "<pre>";
        // echo $string;
        // echo "</pre>";
    }
    ...
    private function HandleError(\Exception $exc) {
        ...
        // TODO: vygenerovat response error
        $response = $this->Response($exc);
    ...
    */
    ...
    //         $msg = sprintf("Engine.DataProvide failure (%s), section=%s%s", $exc->getMessage(), $section->GetKey(), is_null($key) ? '' : '.'.$key);
